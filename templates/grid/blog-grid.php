...
<div class="main-container">
	...
	// CHANGEMENT DU HEADING

	echo '<h1 id="blog" class="chic-title"> Dernières publications </h1>';	
		...
		while ( have_posts() ) :
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
				...
				<div class="post-media">
					<!--CHANGEMENT DU HEADING AJOUT DU TITRE -->
					
					<a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php the_title(); ?>" aria-label="Lire la suite"></a>					
	...
	echo '<p class="text-center"><a class="chic-bouton" titre="Voir tous les articles" href="'. get_site_url() .'/#blog">Voir tous les articles</a></p>';
